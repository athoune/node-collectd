...
Packet.prototype.COUNTER = function(value) {
	this.buffer[this.length] = 0;
	this.length += 1;
	this.appendInt64(value);
};

Packet.prototype.GAUGE = function(value) {
	this.buffer[this.length] = 1;
	this.length += 1;
};

Packet.prototype.DERIVE = function(value) {
	this.buffer[this.length] = 2;
	this.length += 1;
};

Packet.prototype.ABSOLUTE = function(value) {
